...
SESSION_CONFIGS = [
    ...
    {
        'name': 'p1_frst2',
        'display_name': "p1_frst2",
        'num_demo_participants': 8,
        'app_sequence': ['p1_frst2'],
        'treatment': '6',
    },
    {
        'name': 'p1_no2',
    ...
    {
        'name': 'p1_exo2',
        'display_name': "p1_exo2",
        'num_demo_participants': 8,
        'app_sequence': ['p1_exo2'],
        'treatment': '8',
    },
    {
        'name': 'p1_endo2',
        'display_name': "p1_endo2",
        'num_demo_participants': 8,
        'app_sequence': ['p1_endo2'],
        'treatment': '9',
    },
    {
        'name': 'p1_vctm2',
        'display_name': "p1_vctm2",
        'num_demo_participants': 8,
        'app_sequence': ['p1_vctm2'],
        'treatment': '10',
    },
    {
        'name': 'p1_vctm5',
        'display_name': "p1_vctm5",
        'num_demo_participants': 8,
        'app_sequence': ['p1_vctm5'],
        'treatment': '11',
    },
]
