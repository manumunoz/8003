...
doc = """
Web of Lies 2-player: Player 1
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_2Study_P1'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'two_p1/Instructions.html'
    instructions_beliefs = 'two_p1/InstructionsBeliefs.html'
    instructions_belief_number = 'two_p1/Instbeliefnumber.html'
    instructions_belief_yesno = 'two_p1/Instbeliefyesno.html'
