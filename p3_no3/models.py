...
class Constants(BaseConstants):
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p3_no3/Instructions.html'
    instructions_beliefs = 'p3_no3/InstructionsBeliefs.html'
    instructions_belief_number = 'p3_no3/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p3_no3/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p3_no3/Instbeliefyesno.html'
    ...
    with open('p3_no3/imp_p2_no3_s1.csv', 'r') as f:
        reader = csv.reader(f)
