...
doc = """
Web of Lies 2-player: Player 2
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_2Study_P2'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'two_p2/Instructions.html'
    instructions_beliefs = 'two_p2/InstructionsBeliefs.html'
    instructions_belief_number = 'two_p2/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'two_p2/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'two_p2/Instbeliefyesno.html'
    exo_prob_show = 80 # Complete for EXO once ENDO is conducted
    exo_prob_no_show = 20 # Complete for EXO once ENDO is conducted

    with open('two_p2/imp_p1_endo3.csv', 'r') as f:
        reader = csv.reader(f)
