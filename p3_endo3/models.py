...
doc = """
Web of Lies P3_ENDO3
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_P3_endo3'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p3_endo3/Instructions.html'
    instructions_beliefs = 'p3_endo3/InstructionsBeliefs.html'
    instructions_belief_number = 'p3_endo3/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p3_endo3/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p3_endo3/Instbeliefyesno.html'
    ...
    with open('p3_endo3/imp_p2_endo3_s1.csv', 'r') as f:
        reader = csv.reader(f)
