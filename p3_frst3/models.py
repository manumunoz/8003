...
doc = """
Web of Lies P3_FRST3
"""


class Constants(BaseConstants):
    name_in_url = 'MTurk_P3_frst3'
    ...
    max_report = 30
    num_blocks = 144
    instructions_template= 'p3_frst3/Instructions.html'
    instructions_beliefs = 'p3_frst3/InstructionsBeliefs.html'
    instructions_belief_number = 'p3_frst3/Instbeliefnumber.html'
    instructions_belief_hiddennumber = 'p3_frst3/Instbeliefhiddennumber.html'
    instructions_belief_yesno = 'p3_frst3/Instbeliefyesno.html'
    ...
    with open('p3_frst3/imp_p2_frst3_s1.csv', 'r') as f:
        reader = csv.reader(f)
